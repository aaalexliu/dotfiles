...
# Build the flake host entry matching this machine's name. Pass the name as the
# first arg (./bootstrap.sh alex-jxp) if this machine isn't in flake.nix's
# `hosts` list under its current name yet - add it there first.
